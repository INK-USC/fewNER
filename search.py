...
def train_model(config: Config, epoch: int, train_loader: DataLoader, dev_loader: DataLoader):
...
def main():
    ...
    if opt.mode == "train":
        ...
        # entity candidate
        # print(entity_candidate.prompt_candidates)
        # print(len(entity_candidate.prompt_candidates))
        # print(entity_candidate.prompt_candidates['PER'])
        ...
        for combination in permutations_dicts:
            ...
            dev_score = train_model(conf, conf.num_epochs, train_dataloader, dev_dataloader)
        ...
        f = open(conf.dataset + "_" + conf.percent_filename_suffix + "_" + "combination.pkl", 'wb')
